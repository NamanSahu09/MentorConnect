  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-1/5 bg-white p-5 shadow-lg">
        ...
        <button onClick={handleLogout} className="mt-2 flex items-center space-x-1 text-red-500">
      ...
      <main className="flex-1 p-6">
        ...
        <div className="mt-6">
          ...
          <ul className="bg-white p-5 rounded-lg shadow-md">
            <li className="flex justify-between py-2 border-b">LOGIN <span>12th June 2025, 7:05 pm</span></li>
