...
const getRandomEmoji = (seed) => {
  const emojiList = ["👩‍🎓", "👨‍🎓", "🧑‍💻", "👨‍💻", "👩‍💼", "👨‍🏫", "🧑‍🏫", "👨‍🔬", "👩‍🔬"];
  const index = seed % emojiList.length;
          ...
          <div className="flex border border-gray-300 rounded-lg overflow-hidden">
            ...
            <div className="w-1/3 bg-gray-50 p-4 border-r">
              ...
              <div className="bg-white p-3 rounded-lg shadow mb-2 cursor-pointer flex items-center">
                <span className="text-2xl mr-2">{getRandomEmoji(3)}</span>
                <div>
            ...
            <div className="w-2/3 flex flex-col p-4">
              <div className="flex-1 overflow-y-auto bg-white p-4 rounded-lg shadow-md w-3/4 mx-auto">
                ...
                <div className="mb-4 flex items-center space-x-2">
                  <span className="text-3xl">{getRandomEmoji(3)}</span>
                  <div>
                    <p className="text-gray-700 font-semibold">Anonymous <span className="text-xs text-gray-400">11:15 PM</span></p>
                    <p className="bg-gray-200 p-2 rounded-lg inline-block">Hello, how are you?</p>
                  </div>
                </div>
                ...
                <div className="mb-4 flex justify-end items-center space-x-2">
                  <div>
                    <p className="text-right text-gray-700 font-semibold">{user ? user.displayName || "You" : "You"} <span className="text-xs text-gray-400">11:16 PM</span></p>
                    <p className="bg-blue-500 text-white p-2 rounded-lg inline-block">I am good.</p>
                  </div>
                  <span className="text-3xl">{getRandomEmoji(user?.uid?.length || 5)}</span>
                </div>
              </div>

              {/* Message Input */}
              <div className="mt-4 flex w-3/4 mx-auto">
                <input type="text" className="flex-1 p-2 border border-gray-300 rounded-lg" placeholder="Type your message..." />
