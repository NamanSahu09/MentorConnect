  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-1/5 bg-white p-5 shadow-lg">
        ...
        <button onClick={handleLogout} className="mt-4 mr-2 flex items-center space-x-1 text-red-500 px-4 py-2 rounded-lg bg-gray-200 transition delay-300 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 ...">
