  ...
  return (
    <>
      ...
      <div className="w-1/5 bg-white shadow-md flex flex-col h-[100vh]">
       ...
       {/* Right Section - Comments */}
<div className="w-1/5 bg-white border-l flex flex-col justify-between p-4 h-[100vh]">

{/* Top: Comments Title & List */}
<div>
  <h3 className="font-bold text-lg mb-3">Comments</h3>
  <div className="space-y-3 text-sm overflow-y-auto max-h-[75vh] pr-1">
