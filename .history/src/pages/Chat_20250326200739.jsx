  ...
  return (
    <>
      ...
      <div className="flex h-screen bg-gray-100 w-full">
        ...
        {/* Main Chat Section */}
        <main className="flex-1 p-4 flex flex-col bg-white shadow-md w-full">
            ...
            <div className="w-3/4 flex flex-col p-4">
              <div className="flex-1 overflow-y-auto bg-gray-50 p-3 rounded-lg">
                <div className="mb-4 text-left">
                  <p className="bg-gray-200 p-2 rounded-lg inline-block">Hello student, this is your mentor</p>
                </div>
