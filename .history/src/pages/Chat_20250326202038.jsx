        ...
        <main className="flex-1 p-4 flex flex-col bg-white shadow-md">
          ...
          <div className="flex border border-gray-300 rounded-lg overflow-hidden">
            ...
            <div className="w-full flex flex-col p-4">
              ...
              <input type="text" className="flex-1 p-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"/>
               <button className="ml-2 px-5 py-2 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition">Send</button>
