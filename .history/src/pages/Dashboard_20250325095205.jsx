...
const Dashboard = () => {
  ...
  className="mt-4 mr-2 flex items-center space-x-2 text-blue-500 px-4 py-2 rounded-lg bg-gray-200 transition-transform duration-300 ease-in-out hover:-translate-y-1 hover:scale-105 hover:bg-indigo-500 hover:text-red shadow-md hover:shadow-lg">
