...
const LeftBar = () => {
  ...
  return (
    <aside className="h-screen flex flex-col justify-between bg-white shadow-lg p-4 w-full">
      {/* Navigation */}
      ...
      <button
        ...
        className="flex items-center justify-center space-x-2 text-red-500 px-4 py-2 mt-4 rounded-lg bg-black transition duration-300 hover:bg-red-600 hover:text-white shadow-md"
      >
